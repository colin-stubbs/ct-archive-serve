...
- Use a consistent project layout:
  - bin/: compiled binary output location
  - build/cmd/: application entrypoints
  - tests/: test utilities, mocks, and integration tests
...
- Use **golangci-lint** for linting Go code
- Use **hadolint** for linting Dockerfile files
- Use **yamllint** for linting of YAML files, e.g. .yml or .yaml extension
- Use **trivy** and **govulncheck** for code vulnerability and related security checks
